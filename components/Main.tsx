    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center md:items-stretch">
                ...
                <Card title={"What about movies?"} description={"How many movies did you see? Find them and add them to your profile!"} image={"/images/movie-theater.jpg"} path={"movies"} />
            </div>
        </div>
